...
from .google import get_google_news, get_google_news_with_dates
...
VENDOR_METHODS = {
    ...
    "get_news": {
        ...
        "google": get_google_news_with_dates,
        "local": [get_finnhub_news, get_reddit_company_news, get_google_news_with_dates],
    },
    "get_global_news": {
